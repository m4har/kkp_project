...
--
-- Host: localhost:3306
-- Generation Time: May 11, 2023 at 03:28 AM
...
--
-- Table structure for table `barangreturn`
--

CREATE TABLE `barangreturn` (
  `id` varchar(10) NOT NULL,
...
('k2', 'staff', 'asep', 'cibinong', '08585858', 'asep@ganteng.com', 'asep', 0);
...
--
-- Indexes for table `barangreturn`
--
ALTER TABLE `barangreturn`
  ADD PRIMARY KEY (`id`),
...
--
-- Constraints for table `barangreturn`
--
ALTER TABLE `barangreturn`
  ADD CONSTRAINT `barangreturn_ibfk_1` FOREIGN KEY (`idBarang`) REFERENCES `barang` (`id`),
  ADD CONSTRAINT `barangreturn_ibfk_2` FOREIGN KEY (`idKaryawan`) REFERENCES `karyawan` (`id`);
